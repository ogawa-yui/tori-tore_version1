...
my $test_log_file = &Info::get_all_posttest_responses_file_path; 
...
my $choices_answer_file = &Info::get_all_post_choices_answer_file_path;
...
if ($question == $count_quiz){
	$next_url = "17_posttest_score.cgi";
	$next_content = "次へ";
}
